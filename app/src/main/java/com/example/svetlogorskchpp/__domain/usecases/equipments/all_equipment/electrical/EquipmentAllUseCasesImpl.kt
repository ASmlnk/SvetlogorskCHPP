...
class EquipmentAllUseCasesImpl @Inject constructor(
    ...
    private val miUseCases: EquipmentMechanismInfoListUseCasesImpl
    ...
    override fun getSearchElectricalEquipment(
        ...
        val miFlow = miUseCases.getSearchElectricalEquipment(searchQuery, prefixQuery)
        return combine(
            tsnFlow,
            elMotorFlow,
            lightingAndOtherFlow,
        ...
        }.combine(miFlow) {combineValues, mi -> combineValues + mi
        }
    }
}