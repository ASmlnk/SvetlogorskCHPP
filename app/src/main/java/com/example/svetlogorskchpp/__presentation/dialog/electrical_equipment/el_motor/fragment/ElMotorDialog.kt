...
class ElMotorDialog : BaseEquipmentBottomSheetDialog<DialogEquipmentElMotorBinding>() {
    ...
    fun setupImageCategory(category: ElCategory) {
        binding.ivCategory.apply {
            when (category) {
                ElCategory.OTHER -> setImageResource(R.drawable.flash_4049918)
                ElCategory.TREATMENT_FACILITIES -> setImageResource(R.drawable.free_icon_water_treatment)
                ElCategory.DESALTING -> setImageResource(R.drawable.free_icon_filters)
                ElCategory.BNT -> setImageResource(R.drawable.free_icon_bnt)
                ElCategory.Bagernaya -> setImageResource(R.drawable.free_icon_bagern)
                ElCategory.KO -> setImageResource(R.drawable.free_icon_water_ko)
                ElCategory.KTC_KO -> setImageResource(R.drawable.free_icon_water_ko)
                ElCategory.KTC_TO -> setImageResource(R.drawable.factory_1643683)
                ElCategory.NDV -> setImageResource(R.drawable.free_icon_tower)
                ElCategory.PN -> setImageResource(R.drawable.free_icon_pn)
                ElCategory.PEN -> setImageResource(R.drawable.free_icon_pump)
                ElCategory.PRETREATMENT -> setImageResource(R.drawable.free_icon_water_cleaning)
                ElCategory.SN -> setImageResource(R.drawable.factory_1643683)
                ElCategory.TY -> setImageResource(R.drawable.free_icon_oil_tank)
                ElCategory.CN -> setImageResource(R.drawable.icon_nuclear_power)
                ElCategory.CCR -> setImageResource(R.drawable.free_icon_ccr)
                ElCategory.AMMONIA -> setImageResource(R.drawable.free_icon_ammonia)
                ElCategory.GIDROZIYNOE -> setImageResource(R.drawable.icon_pngwing)
                ElCategory.ACIDIC -> setImageResource(R.drawable.free_icon_acid)
                ...
                ElCategory.SOVEVOE -> setImageResource(R.drawable.free_icon_clean)
                ...
                ElCategory.ALKALINE -> setImageResource(R.drawable.free_icon_ph)
