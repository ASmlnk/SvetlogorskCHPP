...
import com.example.svetlogorskchpp.__presentation.shift_schedule_edit_composition.adapter.ItemJobTitlePersonalCallback
...
class ShiftPersonalAdapter(private val shift: Shift) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int) = ShiftPersonalHolder.layoutFrom(parent)
